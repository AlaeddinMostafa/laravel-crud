            ...
            <form action="{{ route('slider.store') }}" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group mt-md-2">
                    ...
                    <select
                        ...
                        <option value="1" class="text-success" {{ old('status') == 1 ? "selected" : "" }}>Active</option>
                        <option value="0" class="text-warning" {{ old('status') == 0 ? "selected" : "" }}>deActive</option>
                    </select>
                    @error('status')
                    <span class="text-warning">{{ $message }}</span>
                    @enderror
                ...
                {{--button--}}
                <button class="btn btn-md btn-dark" type="submit" name="submit">submit</button>
